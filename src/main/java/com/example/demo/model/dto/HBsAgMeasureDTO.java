...
public class HBsAgMeasureDTO {
    ...
    public HBsAgMeasureDTO() {
    }

    public HBsAgMeasureDTO(Long id, String measure_type, String measure_date, String measure_val, String lot, String test) {
        this.id = id;
