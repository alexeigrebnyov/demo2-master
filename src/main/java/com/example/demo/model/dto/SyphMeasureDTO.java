...
public class SyphMeasureDTO {
    ...
    public SyphMeasureDTO() {
    }

    public SyphMeasureDTO(Long id, String measure_type, String measure_date, String measure_val, String lot, String test) {
        this.id = id;
