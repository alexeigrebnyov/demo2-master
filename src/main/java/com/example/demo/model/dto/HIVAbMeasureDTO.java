...
public class HIVAbMeasureDTO {
    ...
    public HIVAbMeasureDTO() {
    }

    public HIVAbMeasureDTO(Long id, String measure_type, String measure_date, String measure_val, String lot, String test) {
        this.id = id;
