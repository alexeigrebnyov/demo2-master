...
@Entity
@Table(name = "syphtest", uniqueConstraints = {@UniqueConstraint(columnNames = {"id"})})
public class SyphTest {
    @Id
    ...
    public SyphTest(Long id, String name, String lot, LocalDateTime dateFrom, LocalDateTime dateTo, int number, List<SyphMeasure> measureList, String inuse) {
        this.id = id;
        this.name = name;
        this.lot = lot;
