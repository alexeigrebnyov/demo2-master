...
@Entity
@Table(name = "hivAbtest", uniqueConstraints = {@UniqueConstraint(columnNames = {"id"})})
public class HIVAbTest {
    @Id
    ...
    public HIVAbTest(Long id, String name, String lot, LocalDateTime dateFrom, LocalDateTime dateTo, int number, List<HIVAbMeasure> measureList, String inuse) {
        this.id = id;
        this.name = name;
        this.lot = lot;
