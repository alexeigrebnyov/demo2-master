...
@Entity
@Table(name = "lot", uniqueConstraints = {@UniqueConstraint(columnNames = {"id"})})
public class Lot {
    @Id
    ...
    public Lot(Long id, String name, String lot, LocalDateTime dateFrom, LocalDateTime dateTo, int number, List<Measure> measureList,
               String inuse) {
        this.id = id;
        this.name = name;
        this.lot = lot;
