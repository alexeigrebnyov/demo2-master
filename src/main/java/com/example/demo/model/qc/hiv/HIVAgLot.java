...
@Entity
@Table(name = "hivAglot", uniqueConstraints = {@UniqueConstraint(columnNames = {"id"})})
public class HIVAgLot {
    @Id
    ...
    public HIVAgLot(Long id, String name, String lot, LocalDateTime dateFrom, LocalDateTime dateTo, int number, List<HIVAgMeasure> measureList,
                    String inuse) {
        this.id = id;
        this.name = name;
        this.lot = lot;
