...
@Entity
@Table(name = "hbsAglot", uniqueConstraints = {@UniqueConstraint(columnNames = {"id"})})
public class HBsAgLot {
    @Id
    ...
    public HBsAgLot(Long id, String name, String lot, LocalDateTime dateFrom, LocalDateTime dateTo, int number, List<HBsAgMeasure> measureList,
                    String inuse) {
        this.id = id;
        this.name = name;
        this.lot = lot;
