...
@Entity
@Table(name = "test", uniqueConstraints = {@UniqueConstraint(columnNames = {"id"})})
public class Test {
    @Id
    ...
    public Test(Long id, String name, String lot, LocalDateTime dateFrom, LocalDateTime dateTo, int number, List<Measure> measureList, String inuse) {
        this.id = id;
        this.name = name;
        this.lot = lot;
