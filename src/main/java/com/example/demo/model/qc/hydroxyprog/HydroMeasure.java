package com.example.demo.model.qc.hydroxyprog;
...
@Entity
@Table(name = "hydromeasure", uniqueConstraints = {@UniqueConstraint(columnNames = {"id"})})
public class HydroMeasure  implements InterMeasure {
    @Id
    ...
    @JoinColumn(name = "hydrolot_fk")
    @JsonBackReference(value = "measure-lot")
    private HydroLot lot;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "hydrotest_fk")
    @JsonBackReference(value = "measure-test")
    private HydroTest test;

    public HydroMeasure() {
    }

    public HydroMeasure(Long id, String measure_type, LocalDateTime measure_date, String measure_val, HydroLot lot, HydroTest test) {
        this.id = id;
    ...
    public HydroLot getLot() {
        return lot;
    }

    public void setLot(HydroLot lot) {
        this.lot = lot;
    }

    public HydroTest getTest() {
        return test;
    }

    public void setTest(HydroTest test) {
        this.test = test;
    }
    ...
    public boolean equals(Object o) {
        ...
        HydroMeasure measure = (HydroMeasure) o;
