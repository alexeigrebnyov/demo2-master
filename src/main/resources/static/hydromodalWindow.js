...
function initLotModalValues(end='', second='', third='') {
    fetch("/hydroqc/"+end).then((res) => res.json())
        .then((data) => {
...
function updateLotModalValues(end='') {
    fetch("/hydroqc/"+document.getElementById("updateInput").value+document.getElementById("lot").value).then((res) => res.json())
        .then((data) => {
...
function saveLotTester() {
    fetch("/hydroqc/"+document.getElementById("saverInput").value,
        {
            headers: {
