...
function initLotModalValues(end='', second='', third='') {
    fetch("/amgqc/"+end).then((res) => res.json())
        .then((data) => {
...
function updateLotModalValues(end='') {
    fetch("/amgqc/"+document.getElementById("updateInput").value+document.getElementById("lot").value).then((res) => res.json())
        .then((data) => {
...
function saveLotTester() {
    fetch("/amgqc/"+document.getElementById("saverInput").value,
        {
            headers: {
