...
function initLotModalValues(end='', second='', third='') {
    fetch("/hivabqc/"+end).then((res) => res.json())
        .then((data) => {
...
function updateLotModalValues(end='') {
    fetch("/hivabqc/"+document.getElementById("updateInput").value+document.getElementById("lot").value).then((res) => res.json())
        .then((data) => {
...
function saveLotTester() {
    fetch("/hivabqc/"+document.getElementById("saverInput").value,
        {
            headers: {
