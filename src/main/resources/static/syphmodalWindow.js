...
function initLotModalValues(end='', second='', third='') {
    fetch("/syphqc/"+end).then((res) => res.json())
        .then((data) => {
...
function updateLotModalValues(end='') {
    fetch("/syphqc/"+document.getElementById("updateInput").value+document.getElementById("lot").value).then((res) => res.json())
        .then((data) => {
...
function saveLotTester() {
    fetch("/syphqc/"+document.getElementById("saverInput").value,
        {
            headers: {
